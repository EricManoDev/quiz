...
public class Question {
    ...
    public String toString() {
        return "Question{" + "titreQuestion=" + titreQuestion + ", reponse1=" + reponse1 + ", reponse2=" + reponse2 + ", reponse3=" + reponse3 + ", reponse4=" + reponse4 + ", numReponseCorrecte=" + numReponseCorrecte + '}';
    }
